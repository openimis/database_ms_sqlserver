...
CREATE OR ALTER PROCEDURE [dbo].[uspInsertIndexMonthly]
(
@Type varchar(1),
...
CREATE OR ALTER PROCEDURE [dbo].[uspBatchProcess]
...
CREATE OR ALTER PROCEDURE [dbo].[uspSSRSOverviewOfCommissions]
(
	@Month INT,
	@Year INT, 
	@Mode INT=NULL,
